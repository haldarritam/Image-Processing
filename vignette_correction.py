...
def correct_channel(img_array, channel, std_vig_model):
  ...
  max_a = np.amax(std_corrected)
  x = 1 / max_a
  #Reconstruct the output image.
  output_img_channel = std_corrected * img_max * x
...
def run_method(vig_red_mth, vig_aux_data, auto_vig_output, image=None, std_vig_model=None):
    '''
    ...
    vig_aux_data is a dictionary containing:
        ...
        in_path: input path where the raw images are
    ...
    '''
    in_path = vig_aux_data.get('in_path')
    ...
    if vig_red_mth == 'auto':
            ...
            app_run_command = "-r 'vignette_removal " + in_path + " " + auto_vig_output + "; exit;';"
